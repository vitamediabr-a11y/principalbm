...
export default async function CustomersPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <div className="space-y-5">
    ...
    <Card className="p-4">
      <form method="get" role="search" aria-label="Buscar e filtrar clientes" className="grid gap-3 md:grid-cols-[minmax(220px,2fr)_1fr_1fr_1fr_auto]">
        <div className="relative"><label htmlFor="customer-search" className="sr-only">Buscar clientes</label><Search className="pointer-events-none absolute left-3 top-3.5 size-4 text-slate-400" /><Input id="customer-search" type="search" name="q" defaultValue={params.q} placeholder="Nome, telefone ou criança" className="pl-9" aria-label="Buscar clientes" /></div>
