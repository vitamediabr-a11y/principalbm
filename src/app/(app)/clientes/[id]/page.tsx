  ...
  try {
    ...
    return <div className="space-y-5">
      ...
      <section aria-labelledby="journeys-title" className="space-y-3">
        <div className="flex items-center justify-between"><h2 id="journeys-title" className="text-lg font-bold">Jornadas</h2><Link href={`/clientes/${customer.id}/jornada`} className="inline-flex min-h-10 items-center gap-1 text-sm font-semibold text-slate-700 hover:underline">Ver jornada <ArrowRight className="size-4" /></Link></div>
