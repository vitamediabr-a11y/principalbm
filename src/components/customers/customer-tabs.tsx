...
const future = ["Compras", "Interações", "Preferências", "Tarefas", "Notas", "Consentimentos"];

export function CustomerTabs({ customerId, active }: { customerId: string; active: "overview" | "journey" | "children" | "opportunities" }) {
